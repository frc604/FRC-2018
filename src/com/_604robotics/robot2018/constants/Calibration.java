...
public class Calibration {
    ...
    public static class DriveFactors {
		...
		private DriveFactors() {}
    }

    // second to last = coefficient, second value = offset
    static {
        System.out.println("Clicks over inches is "+DriveFactors.DRIVE_PROPERTIES.getClicksOverInches());
        System.out.println("Clicks over degrees is "+DriveFactors.DRIVE_PROPERTIES.getDegreesOverClicks());
    }
    
    public static class DriveMovementFactors {
		// Testing targets
		public static final double DRIVE_ROTATE_LEFT_TARGET
		= AutonMovement.degreesToClicks(DriveFactors.DRIVE_PROPERTIES, 360);
		public static final double DRIVE_ROTATE_RIGHT_TARGET
		= AutonMovement.degreesToClicks(DriveFactors.DRIVE_PROPERTIES, -360);
		public static final double DRIVE_MOVE_FORWARD_TARGET
		= AutonMovement.inchesToClicks(DriveFactors.DRIVE_PROPERTIES, 72);
		...
		= AutonMovement.empericalInchesToClicks(DriveFactors.DRIVE_PROPERTIES, 36);
		private DriveMovementFactors() {}
    }
    
    public static class ElevatorFactors {
		// Elevator
